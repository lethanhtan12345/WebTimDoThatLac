...
<body style="background-image: url(<?php echo e(asset('assets/img/sky.jpg')); ?>);background-repeat: no-repeat;background-size: cover" >
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <a href="/admin/tai-khoan" class="logo d-flex align-items-center">
      ...
      <p class="card-title"><?php echo e(Session::get('username')); ?></p>
    </a>
...
</html><?php /**PATH D:\LT_PHP\WebTimDo\myproject\resources\views/nguoidung.blade.php ENDPATH**/ ?>