  ...
  <a href="/admin/chi-tiet/<?php echo e($tintuc->id); ?>">
    <div class="card" style="border-radius: 30px" >
      <div class="card-body">
        ...
        <a href="/admin/cap-nhat-tin-tuc/<?php echo e($tintuc->id); ?>" class="btn btn-primary">Cập nhật</a>
        <a href="/admin/xoa-tin-tuc/<?php echo e($tintuc->id); ?>" class="btn btn-warning">Xóa</a>  
      </div>
    </div>
  </a>               
...
<?php echo $__env->make('nguoidung', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LT_PHP\WebTimDo\myproject\resources\views/adminwebtimdo/tintucnguoidung.blade.php ENDPATH**/ ?>