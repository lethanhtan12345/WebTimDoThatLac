...
<form class="row g-3 needs-validation"  method="POST" action="<?php echo e(route('admin-xu-li-cap-nhat-tin-tuc',['id'=>$tintuc->id])); ?>"  enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    
    <div class="col-12">
        <label for="" class="form-label">Username</label>
        <input type="text" name="username" class="form-control" id="" required readonly value="<?php echo e($tintuc->username); ?>">
    </div>
...
<?php echo $__env->make('quanly', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\LT_PHP\WebTimDo\myproject\resources\views/quanly/capnhattintuc.blade.php ENDPATH**/ ?>